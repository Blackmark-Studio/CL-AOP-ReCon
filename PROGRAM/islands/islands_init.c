void InitIslands()
{
	...
	for (i=0; i<MAX_ISLANDS; i++)
	{
		...
		Islands[i].type = "inhabited";
		Islands[i].colonyquantity = 1;
		Islands[i].net = true;
		
		Islands[i].InterfaceTextures.t1 = "battle_interface\moor_7.tga";
		Islands[i].InterfaceTextures.t1.h = 4;
		Islands[i].InterfaceTextures.t1.v = 1;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l3.mayak = true;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].LoadGroup.g1 = "IslandShips1"; //Порт-Ройал
		Islands[n].LoadGroup.g2 = "IslandShips3"; //Форт Оранж
		...
		Islands[n].reload.l5.tex = "t1";
		Islands[n].reload.l5.mayak = true;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].colonyquantity = 2;
		Islands[n].LoadGroup.g1 = "IslandShips1";
		Islands[n].LoadGroup.g2 = "IslandShips4";
		...
		Islands[n].reload.l6.mayak = true;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].colonyquantity = 2;
		Islands[n].LoadGroup.g1 = "IslandShips1";
		Islands[n].LoadGroup.g2 = "IslandShips3";
	...
	/////////////////////////////////////////////////////////////////////////
	/// Hispaniola1 (SantoDomingo, LaVega)
	/////////////////////////////////////////////////////////////////////////
		n = n + 1;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l4.pic = 0;
		Islands[n].reload.l4.tex = "t1";
        Islands[n].reload.l4.mayak = true;
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l5.label = "DesMoines";
		Islands[n].reload.l5.name = "reload_4";
		Islands[n].reload.l5.go = "DesMoines_town";
	...
	/////////////////////////////////////////////////////////////////////////
		...
		Islands[n].reload.l1.label = "Providencia Port";
		Islands[n].reload.l1.name = "reload_1";
		Islands[n].reload.l1.go = "Providencia_town";
		Islands[n].reload.l1.emerge = "reload1";
		Islands[n].reload.l1.radius = 600.0;
		Islands[n].reload.l1.pic = 0;
		Islands[n].reload.l1.tex = "t1";
		...
		Islands[n].reload.l2.label = "Providencia Fort";
		Islands[n].reload.l2.name = "reload_fort1";
		Islands[n].reload.l2.go = "Providencia_fort";
		Islands[n].reload.l2.GoAfterBoard.location = "reload_1";
		Islands[n].reload.l2.emerge = "see";
		Islands[n].reload.l2.radius = 600.0;
		Islands[n].reload.l2.fortname = "fort_Providencia";
		Islands[n].reload.l2.colonyname = "Providencia";
		Islands[n].reload.l2.fort.model = "Providence_fort1";
		Islands[n].reload.l2.fort.locators = "Providence_fort1_locators";
		Islands[n].reload.l2.pic = 1;
		Islands[n].reload.l2.tex = "t1";
				
		Islands[n].reload.l3.label = "Shore64";
		Islands[n].reload.l3.name = "reload_2";
		Islands[n].reload.l3.go = "Shore64";
		Islands[n].reload.l3.emerge = "sea";
		Islands[n].reload.l3.radius = 300.0;
		Islands[n].reload.l3.pic = 0;
		Islands[n].reload.l3.tex = "t1";

		Islands[n].reload.l4.label = "Shore65";
		Islands[n].reload.l4.name = "reload_3";
		Islands[n].reload.l4.go = "Shore65";
