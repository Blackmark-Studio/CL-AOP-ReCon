int LocationInitCartahena(int n)
{
	...
	locations[n].reload.l31.go = "Cartahena";
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Cartahena_bankvault";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	LAi_LocationFightDisable(&locations[n], true);
	...
	// Хранилище (Банк)
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Cartahena_bankvault";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Cartahena_bank";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	LAi_LocationFightDisable(&locations[n], true);
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Cartahena_Packhouse";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	// Пакгауз
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Cartahena_Packhouse";
	...
	locations[n].reload.l1.go = "Cartahena_Shipyard";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Shipyard";
	
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Cartahena_PackhouseOffice";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Cartahena_PackhouseOffice";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Cartahena_Packhouse";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	...
	Locations[n].models.always.l3 = "ExitCartahena2";
	//Day
	...
	locations[n].islandIdAreal = "Cartahena";
	//Models
	locations[n].filespath.models = "locations\Outside\JunglesN\LighthouseCartahena";
	//Always
	Locations[n].models.always.lighthouse = "lighthouse";
	Locations[n].models.always.l1 = "lighthouse_bsp";
...
/*	Locations[n].models.always.rays = "cavernMedium2_rays";
	...
	locations[n].islandIdAreal = "Cartahena";
	//Models
	locations[n].filespath.models = "locations\Outside\JunglesN\Jungle1";
	//Always
	Locations[n].models.always.jungle = "jungle1";
	Locations[n].models.always.l1 = "jungle1_BSP";	
	...
	Locations[n].models.always.l2.level = 9;
	Locations[n].models.always.l2.tech = "DLightModel";
	Locations[n].models.always.l3 = "Jungle1_cave";
	//Day
	locations[n].models.day.charactersPatch = "Jungle1_patchCave";
	//Night
	locations[n].models.night.charactersPatch = "Jungle1_patchCave";	
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
	//Reload map
