void wdmInitWorldMap()
{
	...
	worldMap.icon.fps = 8;
	worldMap.icon.texture = "Interfaces/Worldmap/icons.tga";
	...
	worldMap.labeltype.Town.heightView = 1250.0;
	worldMap.labeltype.Town.weight = 50;
	
	worldMap.labeltype.Fort.icon = -1;
	worldMap.labeltype.Fort.font = "LABELS_MAPS";	
	worldMap.labeltype.Fort.pivotX = -0.5;
	worldMap.labeltype.Fort.pivotY = -0.5;
	worldMap.labeltype.Fort.heightView = 1150.0;
	worldMap.labeltype.Fort.weight = 1;
	...
	worldMap.labeltype.Shore.heightView = 1200.0;
	...
	worldMap.labels.BugFixFort.type = "Fort";
	worldMap.labels.BugFixFort.id = "BugFix_Fort";
	worldMap.labels.BugFixFort.locator = "Barbados";
	worldMap.labels.BugFixFort.text = "";
	...
	worldMap.labels.Providencia_town.type = "Town";
	worldMap.labels.Providencia_town.id = "Providencia_town";
	...
	worldMap.labels.Bridgetown_Fort.type = "Fort";
	worldMap.labels.Bridgetown_Fort.id = "Bridgetown_Fort";
	worldMap.labels.Bridgetown_Fort.locator = "Bridge_Fort";
	worldMap.labels.Bridgetown_Fort.text = CheckingTranslate(idLngFile,"Bridgetown Fort");

	/*worldMap.labels.Pirates_Fort.type = "Fort";
	worldMap.labels.Pirates_Fort.id = "Pirates_Fort";
	worldMap.labels.Pirates_Fort.locator = "Pirates_Fort";
	worldMap.labels.Pirates_Fort.text = CheckingTranslate(idLngFile,"Pirates Fort");*/
	
	worldMap.labels.SentJons_Fort.type = "Fort";
	worldMap.labels.SentJons_Fort.id = "SentJons_Fort";
	worldMap.labels.SentJons_Fort.locator = "SentJons_Fort";
	worldMap.labels.SentJons_Fort.text = CheckingTranslate(idLngFile,"SentJons Fort");

	worldMap.labels.Beliz_Fort.type = "Fort";
	worldMap.labels.Beliz_Fort.id = "Beliz_Fort";
	worldMap.labels.Beliz_Fort.locator = "Beliz_Fort";
	worldMap.labels.Beliz_Fort.text = CheckingTranslate(idLngFile,"Beliz Fort");

	worldMap.labels.Santiago_Fort.type = "Fort";
	worldMap.labels.Santiago_Fort.id = "Santiago_Fort";
	worldMap.labels.Santiago_Fort.locator = "Santiago_Fort";
	worldMap.labels.Santiago_Fort.text = CheckingTranslate(idLngFile,"Santiago Fort");

	/*worldMap.labels.PuertoPrincipe_Fort.type = "Fort";
	worldMap.labels.PuertoPrincipe_Fort.id = "PuertoPrincipe_Fort";
	worldMap.labels.PuertoPrincipe_Fort.locator = "PuertoPrincipe_Fort";
	worldMap.labels.PuertoPrincipe_Fort.text = CheckingTranslate(idLngFile,"PuertoPrincipe Fort");*/
	...
	worldMap.labels.Cumana_Fort.type = "Fort";
	worldMap.labels.Cumana_Fort.id = "Cumana_Fort";
	worldMap.labels.Cumana_Fort.locator = "Cumana_Fort";
	worldMap.labels.Cumana_Fort.text = CheckingTranslate(idLngFile,"Cumana Fort");

	worldMap.labels.Caracas_Fort.type = "Fort";
	worldMap.labels.Caracas_Fort.id = "Caracas_Fort";
	...
	worldMap.labels.Villemstad_Fort.locator = "Villemstad_Fort";
	worldMap.labels.Villemstad_Fort.text = CheckingTranslate(idLngFile,"Villemstad Fort");

	worldMap.labels.Cartahena_Fort.type = "Fort";
	worldMap.labels.Cartahena_Fort.id = "Cartahena_Fort";
	worldMap.labels.Cartahena_Fort.locator = "Cartahena_Fort";
	worldMap.labels.Cartahena_Fort.text = CheckingTranslate(idLngFile,"Cartahena Fort");

	worldMap.labels.BasTer_Fort.type = "Fort";
	worldMap.labels.BasTer_Fort.id = "BasTer_Fort";
	worldMap.labels.BasTer_Fort.locator = "BasTer_Fort";
	worldMap.labels.BasTer_Fort.text = CheckingTranslate(idLngFile,"BasTer Fort");
	
	worldMap.labels.SantoDomingo_Fort.type = "Fort";
	worldMap.labels.SantoDomingo_Fort.id = "SantoDomingo_Fort";
	worldMap.labels.SantoDomingo_Fort.locator = "SantoDomingo_Fort";
	worldMap.labels.SantoDomingo_Fort.text = CheckingTranslate(idLngFile,"SantoDomingo Fort");

	/*worldMap.labels.LaVega_Fort.type = "Fort";
	worldMap.labels.LaVega_Fort.id = "LaVega_Fort";
	worldMap.labels.LaVega_Fort.locator = "LaVega_Fort";
	worldMap.labels.LaVega_Fort.text = CheckingTranslate(idLngFile,"LaVega Fort");*/

	worldMap.labels.PortPax_Fort.type = "Fort";
	worldMap.labels.PortPax_Fort.id = "PortPax_Fort";
	worldMap.labels.PortPax_Fort.locator = "PortPax_Fort";
	worldMap.labels.PortPax_Fort.text = CheckingTranslate(idLngFile,"PortPax Fort");

	worldMap.labels.Maracaibo_Fort.type = "Fort";
	worldMap.labels.Maracaibo_Fort.id = "Maracaibo_Fort";
	worldMap.labels.Maracaibo_Fort.locator = "Maracaibo_Fort";
	worldMap.labels.Maracaibo_Fort.text = CheckingTranslate(idLngFile,"Maracaibo Fort");

	worldMap.labels.PortRoyal_Fort.type = "Fort";
	worldMap.labels.PortRoyal_Fort.id = "PortRoyal_Fort";
	worldMap.labels.PortRoyal_Fort.locator = "PortRoyal_Fort";
	worldMap.labels.PortRoyal_Fort.text = CheckingTranslate(idLngFile,"PortRoyal Fort");

	/*worldMap.labels.FortOrange_Fort.type = "Fort";
	worldMap.labels.FortOrange_Fort.id = "FortOrange_Fort";
	worldMap.labels.FortOrange_Fort.locator = "FortOrange_Fort";
	worldMap.labels.FortOrange_Fort.text = CheckingTranslate(idLngFile,"FortOrange Fort");*/

	worldMap.labels.FortFrance_Fort.type = "Fort";
	worldMap.labels.FortFrance_Fort.id = "FortFrance_Fort";
	worldMap.labels.FortFrance_Fort.locator = "FortFrance_Fort";
	worldMap.labels.FortFrance_Fort.text = CheckingTranslate(idLngFile,"FortFrance Fort");

	/*worldMap.labels.LeFransua_Fort.type = "Fort";
	worldMap.labels.LeFransua_Fort.id = "LeFransua_Fort";
	worldMap.labels.LeFransua_Fort.locator = "LeFransua_Fort";
	worldMap.labels.LeFransua_Fort.text = CheckingTranslate(idLngFile,"LeFransua Fort");*/

	worldMap.labels.Marigo_Fort.type = "Fort";
	worldMap.labels.Marigo_Fort.id = "Marigo_Fort";
	worldMap.labels.Marigo_Fort.locator = "Marigo_Fort";
	worldMap.labels.Marigo_Fort.text = CheckingTranslate(idLngFile,"Marigo Fort");

	worldMap.labels.Charles_Fort.type = "Fort";
	worldMap.labels.Charles_Fort.id = "Charles_Fort";
	worldMap.labels.Charles_Fort.locator = "Charles_Fort";
	worldMap.labels.Charles_Fort.text = CheckingTranslate(idLngFile,"Charles Fort");

	worldMap.labels.SanJuan_Fort.type = "Fort";
	worldMap.labels.SanJuan_Fort.id = "SanJuan_Fort";
	worldMap.labels.SanJuan_Fort.locator = "SanJuan_Fort";
	worldMap.labels.SanJuan_Fort.text = CheckingTranslate(idLngFile,"SanJuan Fort");

	worldMap.labels.PortoBello_Fort.type = "Fort";
	worldMap.labels.PortoBello_Fort.id = "PortoBello_Fort";
	worldMap.labels.PortoBello_Fort.locator = "PortoBello_Fort";
	worldMap.labels.PortoBello_Fort.text = CheckingTranslate(idLngFile,"PortoBello Fort");

	/*worldMap.labels.Panama_Fort.type = "Fort";
	worldMap.labels.Panama_Fort.id = "Panama_Fort";
	worldMap.labels.Panama_Fort.locator = "Panama_Fort";
	worldMap.labels.Panama_Fort.text = CheckingTranslate(idLngFile,"Panama Fort");*/

	worldMap.labels.SantaCatalina_Fort.type = "Fort";
	worldMap.labels.SantaCatalina_Fort.id = "SantaCatalina_Fort";
	worldMap.labels.SantaCatalina_Fort.locator = "SantaCatalina_Fort";
	worldMap.labels.SantaCatalina_Fort.text = CheckingTranslate(idLngFile,"SantaCatalina Fort");

	worldMap.labels.PortSpein_Fort.type = "Fort";
	worldMap.labels.PortSpein_Fort.id = "PortSpein_Fort";
	worldMap.labels.PortSpein_Fort.locator = "PortSpein_Fort";
	worldMap.labels.PortSpein_Fort.text = CheckingTranslate(idLngFile,"PortSpein Fort");

	worldMap.labels.Tortuga_Fort.type = "Fort";
	worldMap.labels.Tortuga_Fort.id = "Tortuga_Fort";
	worldMap.labels.Tortuga_Fort.locator = "Tortuga_Fort";
	worldMap.labels.Tortuga_Fort.text = CheckingTranslate(idLngFile,"Tortuga Fort");

	worldMap.labels.Providencia_Fort.type = "Fort";
	worldMap.labels.Providencia_Fort.id = "Providencia_Fort";
	worldMap.labels.Providencia_Fort.locator = "Providencia_Fort";
	worldMap.labels.Providencia_Fort.text = CheckingTranslate(idLngFile,"Providencia Fort");
	...
	//=========================================================================
	//Прибрежные маяки / Lighthouse Shores
	//=========================================================================
	...
	//=========================================================================
	//Внутреняя информация - !!!Осторожно, никаких проверок!!!
	//=========================================================================
	...
	//Player ship
	worldMap.playerShipActionRadius = 22.0;
	...
	worldMap.enemyShipActionRadius = 20.0;		
	//storm
	...
	worldMap.stormShipActionRadius = 20.0;		
	...
	worldMap.islands.Jamaica.FortOrange_town.position.x = -405.0;
	worldMap.islands.Jamaica.FortOrange_town.position.z = -100.0;
	...
	worldMap.islands.Providence.position.x = -524.04;
    worldMap.islands.Providence.position.z = -451.44;
    worldMap.islands.Providence.Providencia_town.position.x = -520.0;
    worldMap.islands.Providence.Providencia_town.position.z = -414.0;
	worldMap.islands.Providence.Shore64.position.x = -549.893;
