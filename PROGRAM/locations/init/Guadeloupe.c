...
{	
	...
	locations[n].reload.l27.name = "houseF3";
	locations[n].reload.l27.go = "CommonTripleFloorHouse";
	...
	locations[n].reload.l30.name = "HutFish2";
	locations[n].reload.l30.go = "CommonHut";
	locations[n].reload.l30.emerge = "reload1";
	locations[n].reload.l30.autoreload = "0";
	locations[n].reload.l30.label = "House";

	locations[n].reload.l31.name = "boat";
	locations[n].reload.l31.go = "Guadeloupe";
	locations[n].reload.l31.emerge = "reload_1";
	locations[n].reload.l31.autoreload = "0";
	locations[n].reload.l31.label = "Sea";
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "BasTer_Packhouse";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	// Пакгауз
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "BasTer_Packhouse";
	...
	locations[n].reload.l1.go = "BasTer_Shipyard";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Shipyard";
	
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "BasTer_PackhouseOffice";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "BasTer_PackhouseOffice";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "BasTer_Packhouse";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "BasTer_bankvault";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	LAi_LocationFightDisable(&locations[n], true);
	...
	// Хранилище (Банк)
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "BasTer_bankvault";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "BasTer_bank";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	LAi_LocationFightDisable(&locations[n], true);
	...
	//Положить по квесту Лейфа Счастливого - Аскольд
	...
	//убрать, когда положим скрижаль для открытия гробницы Лейфа
	// locations[n].models.always.L1 = "cavernBig1_door";
	
	//Для удобства - увеличенный радиус локаторов
	locations[n].locators_radius.item.button01 = 1.0;
	locations[n].locators_radius.item.detector1 = 1.0;
	locations[n].locators_radius.item.item1 = 0.1; // чтобы не конфликтовал с button01
...
/*	Locations[n].models.always.rays = "cavernBig1_rays";
	...
	locations[n].reload.l4.go = "Guadeloupe_Cave";
