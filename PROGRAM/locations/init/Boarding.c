...
int LocationInitBoarding(int n)
{
	...
	Locations[n].image = "loading\Firefort.tga";
	...
	////////////////////////////////////////////////////////////
	//ID
	Locations[n].id = "Providencia_fort";
	locations[n].id.label = "Providencia Fort";
	//Info
	Locations[n].image = "loading\outside\Fort.tga";
	locations[n].townsack = "Providencia";
	//Sound
	locations[n].type = "fort";
	locations[n].parent_colony = "Providencia";
	locations[n].islandId = "Providence";
	locations[n].soldiers = true;
	LAi_LocationFantomsGen(&locations[n], true);
	//Models
	//Always
	Locations[n].filespath.models = "locations\Fort_inside\FortVCave";
	Locations[n].models.always.fortVCave = "fortVCave";
	Locations[n].models.always.fortVCave.tech = "DLightModel";
	locations[n].models.always.fortVCave.level = 65538;
	Locations[n].models.always.fortVCaverock = "fortVCave_rock";
	Locations[n].models.always.fortVCaverock.tech = "DLightModel";
	Locations[n].models.always.fortVCaveseabed = "fortVCave_sb";
	Locations[n].models.always.locators = "fortVCave_locators";
	Locations[n].models.always.grassPatch = "fortVCave_grass";
	Locations[n].models.always.grassPatch.texture = "grass\grassshore.tga.tx";
	...
	locations[n].models.always.l1.level = 9;
	//Day
	locations[n].models.day.charactersPatch = "fortVCave_patch";
	Locations[n].models.day.fortVCaveFonarsDay = "fortVCave_fd";
	//Night
	locations[n].models.night.charactersPatch = "fortVCave_patch";
	Locations[n].models.night.fortVCaveBigNight= "fortVCave_fn";
	//Environment
	locations[n].environment.weather = "true";
	locations[n].environment.sea = "true";
    //Reload map
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Providencia_ammo";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";

	locations[n].reload.l2.name = "reload3_back";
	locations[n].reload.l2.go = "Providence_Cavern";
	locations[n].reload.l2.emerge = "reload2";
	locations[n].reload.l2.autoreload = "1";
	n = n + 1;
	
	////////////////////// ammo ////////////////////////////
	Locations[n].id = "Providencia_ammo";
	locations[n].id.label = "ammo";
	Locations[n].image = "loading\outside\Fort.tga";
	locations[n].townsack = "Providencia";
	locations[n].parent_colony = "Providencia";
    ...
    //Reload map
	Locations[n].reload.l1.name = "reload1";
	Locations[n].reload.l1.go = "Providencia_fort";
	Locations[n].reload.l1.emerge = "reload2";
	Locations[n].reload.l1.autoreload = "0";
	n = n + 1;
...
n = n + 1;	
	...
	Locations[n].id = "Cabin_Small4";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capsm_coas";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	...
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capmd_teho";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	...
	Locations[n].id = "Cabin_Medium3";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capmd_coas";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	...
	Locations[n].id = "Cabin_Medium4";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capmd_coasmod";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	...
	Locations[n].id = "Cabin_Medium5";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capmd_light";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	locations[n].type = "boarding_cabine";
	//Models
	...
	Locations[n].id = "My_Cabin_Small2";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\nc_cabin1";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	...
	Locations[n].id = "My_Cabin_Small3";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\nc_cabin3";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	...
	Locations[n].id = "My_Cabin_Small4";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capsm_coas";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	...
	Locations[n].id = "My_Cabin_Medium3";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capmd_coas";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	...
	Locations[n].id = "My_Cabin_Medium4";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capmd_coasmod";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	...
	Locations[n].id = "My_Cabin_Medium5";
	Locations[n].id.label = "cabine";
	Locations[n].filespath.models = "locations\decks\capmd_light";
    Locations[n].image = "loading\capdeck.tga";
	//Sound
	...
	Locations[n].id = "My_Cabin_Medium6";
	Locations[n].id.label = "cabine";
	Locations[n].image = "loading\capdeck.tga";
	Locations[n].filespath.models = "locations\decks\new_cabin";
	//Sound
	...
	locations[n].box1 = Items_MakeTime(0, 1, 1, 2026);
	locations[n].box2 = Items_MakeTime(0, 1, 1, 2026);
	locations[n].box3 = Items_MakeTime(0, 1, 1, 2026);
	locations[n].box4 = Items_MakeTime(0, 1, 1, 2026);
	...
	Locations[n].image = "loading\trumkor_" + rand(1) + ".tga";
	//Sound
	Locations[n].type = "residence";
	...
	Locations[n].reload.l4.name = "reload_orlop";
	Locations[n].reload.l4.go = "My_Orlop";
	Locations[n].reload.l4.emerge = "reload_camp";
	Locations[n].reload.l4.autoreload = "0";
	Locations[n].reload.l4.label = "My_Orlop.";
	...
	//HardCoffee Наш Кубрик
	Locations[n].id = "My_Orlop";
	Locations[n].id.label = "My_Orlop";
	Locations[n].filespath.models = "locations\decks\Orlop";
	Locations[n].image = "loading\Boarding_" + rand(2) + ".tga";
	//Sound
	Locations[n].type = "residence";

	//Always
	Locations[n].models.always.Orlop = "oldeck";
	Locations[n].models.always.locators = "orlop_locators";
	//Day
	...
	Locations[n].reload.l2.name = "reload_camp";
	Locations[n].reload.l2.go = "My_Deck_Medium";
	Locations[n].reload.l2.emerge = "reload_orlop";
	Locations[n].reload.l2.autoreload = "0";
	Locations[n].reload.l2.label = "My_Orlop.";
	...
	//Info
	Locations[n].image = "loading\sea_" + rand(5) + ".tga";
	//Sound
	Locations[n].type = "residence";
	Locations[n].boarding = "true";
