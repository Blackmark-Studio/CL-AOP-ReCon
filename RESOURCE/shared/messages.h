...
#define MSG_SHIP_SET_CHARACTER_EID 50404
...
// HardCoffee the ability for character to detect a high-altitude locator
#define MSG_UPDATE_LOCATOR_DETECTOR 30158 //"lf" set cylinder height for method FindNearesLocatorCl
// Debug
