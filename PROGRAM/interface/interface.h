...
#define INTERFACE_SHIP_CHOOSE			28 // TODO
#define INTERFACE_COLONY_INFO			29 // TODO
...
// <-- Ugeen
#define INTERFACE_INFOMESSAGE   		41 // интерфейс информационного сообщения
#define INTERFACE_MUSIC_SETTINGS		42 // TODO > интерфейс редактора треков после правок Роса в движке
#define INTERFACE_CONTRABAND			43 // Интерфейс торговли с контрабандистами
#define INTERFACE_ENCYCLOPEDIA			44 // evganat - энциклопедия
#define INTERFACE_PORTMAN   			45 // Интерфейс стоянки кораблей
#define INTERFACE_SHIP_CUSTOMIZE   		46 // Интерфейс изменения внешнего вида корабля
...
#define RC_INTERFACE_RANSACK_MAIN_EXIT			45012 // нужно, используется в seadog.c
...
#define RC_INTERFACE_MUSIC_SETTINGS				45039
#define RC_INTERFACE_CONTRABAND					45040   // Интерфейс торговли с контрабандистами

// evganat - энциклопедия
#define RC_INTERFACE_ENCYCLOPEDIA				45041

#define RC_INTERFACE_CONTRATRADE				45042   // Интерфейс торговли с контрабандистами
#define RC_INTERFACE_REPAIR						45043	// Интерфейс ремонта
#define RC_INTERFACE_ALCHEMY_EXIT				45044   // Интерфейс мультиобъектов
