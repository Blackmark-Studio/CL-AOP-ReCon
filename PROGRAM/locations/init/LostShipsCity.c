...
int LocationInitLostShipsCity(int n)
{
	...
	locations[n].models.always.L1 = "LostShipsCity_part";
	...
	locations[n].reload.l24.disable = true;
	...
	locations[n].reload.l47.name = "reload13";
	locations[n].reload.l47.go = "PlutoStoreSmall";
	locations[n].reload.l47.emerge = "reload6";
	...
	locations[n].reload.l48.name = "reload14";
	locations[n].reload.l48.go = "PlutoStoreSmall";
	locations[n].reload.l48.emerge = "reload5";
	locations[n].reload.l48.autoreload = "0";
	locations[n].reload.l48.label = "PlutoStoreSmall cabin";
	...
	locations[n].locators_radius.item.casper = 1.5;
	...
	//////// Баттлшип Тартарус   TartarusPrison ////////
	...
	locations[n].reload.l74.name = "reload76";
	locations[n].reload.l74.go = "VelascoShipInside1";
	locations[n].reload.l74.emerge = "reload5";
	locations[n].reload.l74.autoreload = "0";
	locations[n].reload.l74.label = "VelascoShipInside1 cabin";

	//////////// проход на корабль внешнего кольца ///////////
	locations[n].reload.l75.name = "reload_ring";
	locations[n].reload.l75.go = "ExternalRingInside";
	locations[n].reload.l75.emerge = "reload1";
	locations[n].reload.l75.autoreload = "0";
	locations[n].reload.l75.disable = true;  //закрыто до поры
	locations[n].locators_radius.reload.reload_ring = 3.5;

	locations[n].reload.l76.name = "reload71";
    locations[n].reload.l76.go = "VelascoBank";
    locations[n].reload.l76.emerge = "reload1";
    locations[n].reload.l76.autoreload = "0";
    locations[n].reload.l76.label = "VelascoShipInside1 cabin";

	//////////// проход в кабину по квесту LSC_Drink ///////////
	locations[n].reload.l77.name = "reload75";
	locations[n].reload.l77.go = "VelascoBank";
	locations[n].reload.l77.emerge = "reload2";
	locations[n].reload.l77.autoreload = "0";
	locations[n].reload.l77.label = "VelascoShipInside1 cabin";
	locations[n].reload.l77.disable = true;  //закрыто до поры

	//////// Флейт Фернандо Диффиндур  верхняя палуба FernandaDiffIndoor ////////
	locations[n].reload.l78.name = "reload77";
	locations[n].reload.l78.go = "FernandaDiffIndoor";
	locations[n].reload.l78.emerge = "reload3";
	locations[n].reload.l78.autoreload = "0";
	locations[n].reload.l78.label = "FernandaDiffIndoor cabin";

	locations[n].reload.l79.name = "reload78";
	locations[n].reload.l79.go = "FernandaDiffIndoor";
	locations[n].reload.l79.emerge = "reload2";
	locations[n].reload.l79.autoreload = "0";
	locations[n].reload.l79.label = "FernandaDiffIndoor cabin";
	...
	locations[n].private2.items.kocherg = 4;
	...
	locations[n].private10.key = "admiralKey";	//у скелета
	...
	locations[n].private11.key = "TizerKey"; //внутри Диффиндура
	...
	locations[n].locators_radius.item.wait = 2.5;
	n = n + 1;
	...
	locations[n].private2.items.kocherg = 1;
	...
	locations[n].private3.items.map_LSC = 1;

	locations[n].private4.money = 3520;
	locations[n].private4.items.mineral3 = 400;
	n = n + 1;
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "LostShipsCity_town";
	locations[n].reload.l2.emerge = "reload78";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "LSC Town";

	locations[n].reload.l3.name = "reload3";
	locations[n].reload.l3.go = "LostShipsCity_town";
	locations[n].reload.l3.emerge = "reload77";
	locations[n].reload.l3.autoreload = "0";
	locations[n].reload.l3.label = "LSC Town";
	...
	locations[n].reload.l6.name = "reload6";
	locations[n].reload.l6.go = "LostShipsCity_town";
	locations[n].reload.l6.emerge = "reload13";
	locations[n].reload.l6.autoreload = "0";
	locations[n].reload.l6.label = "LSC Town";
	...
	locations[n].private2.key = "key2"; //лут
	...
	locations[n].private3.key = "key1"; //лут
	...
	locations[n].private1.items.mushket_flint = 1;
	locations[n].private1.items.potion2 = 2;
	...
	locations[n].private2.key = "key2";
	locations[n].private2.money = 3412;
	locations[n].private2.items.map_trinidad = 1;
	locations[n].private2.items.potion2 = 2;
	locations[n].private2.items.pistol2 = 1;
	locations[n].private2.items.bullet = 11;
	locations[n].private2.items.blade4 = 2;
	locations[n].private2.items.blade5 = 3;
	...
	locations[n].private4.key = "admiralKey";
	locations[n].private4.money = 30230;
	locations[n].private4.items.potion1 = 15;
	locations[n].private4.items.potion3 = 2;
	locations[n].private4.items.blade30 = 1;
	locations[n].private4.items.blade31 = 1;
	locations[n].private4.items.spyglass3 = 1;

	locations[n].private5.key = "admiralKey";
	...
	locations[n].private6.key = "admiralKey";
	...
	locations[n].reload.l5.name = "reload5";
	locations[n].reload.l5.go = "LostShipsCity_town";
	locations[n].reload.l5.emerge = "reload76";
	locations[n].reload.l5.autoreload = "0";
	locations[n].reload.l5.label = "LSC Town";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Галеон Веласко каюта капитана VelascoShipBank (клон каюты Каролины)
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "VelascoBank";
	locations[n].id.label = "VelascoShipInside1 cabin";
	locations[n].filespath.models = "locations\LostShipsCityInsides\CarolineBank";
	locations[n].image = "loading\InsideLSC.tga";
	//Town sack
	...
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "LostShipsCity_town";
	locations[n].reload.l1.emerge = "reload71";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "LSC Town";
	locations[n].reload.l1.disable = true;
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "LostShipsCity_town";
	locations[n].reload.l2.emerge = "reload75";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "LSC Town";

	locations[n].reload.l3.name = "reload3";
	locations[n].reload.l3.go = "LostShipsCity_town";
	locations[n].reload.l3.emerge = "reload75";
	locations[n].reload.l3.autoreload = "0";
	locations[n].reload.l3.label = "LSC Town";

	//ключи для сундуков и предметы внутри
	locations[n].private1.key = "key_drink"; // ключ для всякого квест "Мордой об стол"
	locations[n].private1.money = 20000;
	locations[n].private1.items.jewelry4 = 25;
	locations[n].private1.items.jewelry2 = 50;
	locations[n].private1.items.map_trinidad = 1;
	locations[n].private1.items.indian20 = 1;
	locations[n].private1.items.indian17 = 1;
	locations[n].private1.items.jewelry9 = 1;

	locations[n].private2.key = "key_drinkQ"; // ключ для денег квест "Мордой об стол"
	...
	//////////////////////////////////////////////////////////////////////////////////////////////
	// Квестовая корабельная палуба корабля внешнего кольца LSC (Санта Люсия)
	//////////////////////////////////////////////////////////////////////////////////////////////

	Locations[n].id = "ExternalRingDeck";
	Locations[n].id.label = "Boarding_deck_SantaLucia";
	Locations[n].image = "loading\OutsideLSC.tga";
	locations[n].fastreload = "RingLostShipsCity";
 	locations[n].islandId = "LostShipsCity";
	//Sound
	Locations[n].type = "LostShipsCity";
	...
	locations[n].id.label = "My_Deck_SantaLucia";
	locations[n].filespath.models = "locations\LostShipsCityInsides\PlutoStoreSmall";
	locations[n].image = "loading\InsideLSC.tga";
	locations[n].fastreload = "RingLostShipsCity";
 	locations[n].islandId = "LostShipsCity";
	...
	locations[n].private2.items.mineral3 = 2;

	locations[n].private3.items.mineral2 = 1;
	locations[n].private3.items.mineral3 = 1;

	locations[n].private4.items.potionrum = 40; // 40 бутылок рома

	locations[n].private5.items.mineral2 = 1;

	locations[n].private6.items.potionwine = 20; // 20 бутылок вина

	locations[n].private7.items.potion3 = 1;

	locations[n].private9.items.cirass1 = 1;

	locations[n].private10.items.jewelry15 = 3;
	locations[n].private10.items.jewelry18 = 1;
    ...
    locations[n].id.label = "cabine_SantaLucia";
