...
void initFastReloadTable()
{
	...
	curTable.l4.pic = FRP_RESIDENCE;
	curTable.l4.tex = FRT_RESIDENCE;
	curTable.l4.location = "Villemstad_hall";
	// usurer
	curTable.l5.pic = FRP_USURER;
	curTable.l5.tex = FRT_USURER;
	...
	makearef(curTable,objFastReloadTable.table.Providencia);
	// store
	curTable.l1.pic = FRP_STORE;
	curTable.l1.tex = FRT_STORE;
	curTable.l1.location = "Providencia_store";
	// shipyard
	/*curTable.l2.pic = FRP_SHIPYARD;
	curTable.l2.tex = FRT_SHIPYARD;
	curTable.l2.location = "Providencia_shipyard";*/
	// tavern
	curTable.l3.pic = FRP_TAVERN;
	curTable.l3.tex = FRT_TAVERN;
	curTable.l3.location = "Providencia_tavern";
	// residence
	curTable.l4.pic = FRP_RESIDENCE;
	curTable.l4.tex = FRT_RESIDENCE;
	curTable.l4.location = "Providencia_townhall";
	// usurer
	/*curTable.l5.pic = FRP_USURER;
	curTable.l5.tex = FRT_USURER;
	curTable.l5.location = "Beliz_bank";*/
	...
	curTable.l7.pic = FRP_BROTHEL;
	curTable.l7.tex = FRT_BROTHEL;
	curTable.l7.location = "Providencia_brothel";
	
	curTable.l8.pic = FRP_PORT_OFFICE;
	curTable.l8.tex = FRT_PORT_OFFICE;
	curTable.l8.location = "Providencia_PortOffice";
	
	/*curTable.l9.pic = FRP_PRISON;
	curTable.l9.tex = FRT_PRISON;
	curTable.l9.location = "Beliz_prison";*/
	...
	curTable.l2.pic = FRP_SHIPYARD;
	curTable.l2.tex = FRT_SHIPYARD;
	curTable.l2.location = "FenixPlatform";
	// tavern
	curTable.l3.pic = FRP_TAVERN;
	curTable.l3.tex = FRT_TAVERN;
	...
	curTable.l8.pic = FRP_PORT_OFFICE;
	curTable.l8.tex = FRT_PORT_OFFICE;
	curTable.l8.location = "FernandaDiffIndoor";
    // тюрьма
	curTable.l9.pic = FRP_PRISON;
    curTable.l9.tex = FRT_PRISON;
    curTable.l9.location = "TartarusPrison";
}
...
void InitTownTable()
{
	...
	objTownStateTable.towns.t29.name = "Providencia";
