void InitGoods()
{
	...
	Goods[GOOD_PINCTADA].Name		    = "Pinctada";
	Goods[GOOD_PINCTADA].Weight	    = 1;
	Goods[GOOD_PINCTADA].Cost	        = 4250; //8500
	Goods[GOOD_PINCTADA].Units	    = 700;
	Goods[GOOD_PINCTADA].AfraidWater = 1;
	Goods[GOOD_PINCTADA].canbecontraband	= 0;
	Goods[GOOD_PINCTADA].Norm          = 0;
	Goods[GOOD_PINCTADA].type				= TRADE_TYPE_CONTRABAND;
	...
	Goods[GOOD_CANNON_3].type			= TRADE_TYPE_CANNONS;
	Goods[GOOD_CANNON_3].canbecontraband = 0;
	...
	Goods[GOOD_CANNON_6].type			= TRADE_TYPE_CANNONS;
	Goods[GOOD_CANNON_6].canbecontraband = 0;
	Goods[GOOD_CANNON_6].NotSale		= 0;
	Goods[GOOD_CANNON_6].Norm			= 30;
	...
	/// 48--->>> их не купить и не продать. встречаются на квестовых кораблях и установлены в фортах как мортиры.
	...
	Goods[GOOD_CANNON_48].NotSale		= 0;
