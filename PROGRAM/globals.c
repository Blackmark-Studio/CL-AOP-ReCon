...
string savefile_info = "CL: AoP 1.1.2 (11.06.2026)";
...
#define CONTROL_TIPS_EXTEND 2
#define CONTROL_TIPS_ALL 3
int iShowTips = CONTROL_TIPS_ALL;
...
// Падежи
#define NAME_NOM "Nom"	// Именительный	(Nominative case)
#define NAME_GEN "Gen"	// Родительный	(Genitive case)
#define NAME_DAT "Dat"	// Дательный	(Dative case)
#define NAME_ACC "Acc"	// Винительный	(Accusative case)
#define NAME_INS "Ins"	// Творительный	(Instrumental case)
#define NAME_PRE "Pre"	// Предложный	(Prepositional case)
...
{
	// trace("EventReturn_isGrassLightsOn"); это я перевел на 1 раз за всё время создания травы
	// 1 - светится, 0 - тёмная
