...
#define MSG_BATTLE_LAND_SHOW_EQUIPMENT 46109 // "l"

// spyglass interface commands
#define MSG_ISG_VISIBLE 46201      // "l" (set visible interface)
#define MSG_ISG_UPDATE 46202       // "llssslllffsssllllllllssls"
...
#define MSG_ISG_SET_CHARFRAME 46205 // "sffff" ( texture name, uv_rect{left,top,right,bottom} )
...
#define MSG_ACTIVE_PERK_CAN_SHOW 47002
