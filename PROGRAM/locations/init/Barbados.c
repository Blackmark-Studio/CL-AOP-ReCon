int LocationInitBarbados(int n)
{
    ...
    locations[n].questSeekCap = 6;   //TODO Хомо. этот флаг нужно вернуть на выходе из линейки
    //Sound
    locations[n].type = "town";
    LAi_LocationFantomsGen(&locations[n], true);
    locations[n].houseEnc = true;   //TODO Хомо. этот тоже надо вернуть, генерит хозяев домов
    locations[n].notCloseCommonHouse = true; //TODO Хомо. а этот флаг потом снести, не false, а DeleteAttribute
    //Models
    //Always
    ...
    locations[n].reload.l11.go = "Bridgetown_Hut1";
    ...
    locations[n].reload.jail.name = "reloadT1";
    ...
    locations[n].reload.l2.name = "reload2";
    locations[n].reload.l2.go = "Bridgetown_bankvault";
    locations[n].reload.l2.emerge = "reload1";
    locations[n].reload.l2.autoreload = "0";
    locations[n].reload.l2.label = "Room";
    LAi_LocationFightDisable(&locations[n], true);
    ...
    // Хранилище (Банк)
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    locations[n].id = "Bridgetown_bankvault";
    ...
    //Reload map
    locations[n].reload.l1.name = "reload1_back";
    locations[n].reload.l1.go = "Bridgetown_bank";
    locations[n].reload.l1.emerge = "reload2";
    locations[n].reload.l1.autoreload = "0";
    locations[n].reload.l1.label = "Street";
    LAi_LocationFightDisable(&locations[n], true);
    ...
    locations[n].reload.l2.name = "reload2";
    locations[n].reload.l2.go = "Bridgetown_Packhouse";
    locations[n].reload.l2.emerge = "reload1";
    locations[n].reload.l2.autoreload = "0";
    ...
    // Пакгауз
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    locations[n].id = "Bridgetown_Packhouse";
    ...
    locations[n].reload.l1.go = "Bridgetown_Shipyard";
    locations[n].reload.l1.emerge = "reload2";
    locations[n].reload.l1.autoreload = "0";
    locations[n].reload.l1.label = "Shipyard";

    locations[n].reload.l2.name = "reload2";
    locations[n].reload.l2.go = "Bridgetown_PackhouseOffice";
    locations[n].reload.l2.emerge = "reload1";
    locations[n].reload.l2.autoreload = "0";
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    locations[n].id = "Bridgetown_PackhouseOffice";
    ...
    //Reload map
    locations[n].reload.l1.name = "reload1";
    locations[n].reload.l1.go = "Bridgetown_Packhouse";
    locations[n].reload.l1.emerge = "reload2";
    locations[n].reload.l1.autoreload = "0";
    ...
    Locations[n].reload.l1.name = "reload1";
    Locations[n].reload.l1.go = "Bridgetown_town";
    Locations[n].reload.l1.emerge = "reloadT1_back";
    Locations[n].reload.l1.autoreload = "0";
    Locations[n].reload.l1.label = "Street";
    ...
    locations[n].townsack = "Bridgetown";
    locations[n].islandId = "Barbados";
    locations[n].islandIdAreal = "Bridgetown";
	...
	locations[n].models.always.door = "Plantation_door";
    ...
    locations[n].reload.l2.emerge = "reload1";
    locations[n].reload.l2.autoreload = "1";
    locations[n].reload.l2.label = "Mayak2";
    locations[n].locators_radius.reload.reload2_back = 2;
    //дома
    ...
    locations[n].reload.l14.go = "Bridgetown_Plantation_F1";
    ...
    locations[n].reload.l2.name = "reload2";
    locations[n].reload.l2.go = "Bridgetown_Plantation_Sp2";
    locations[n].reload.l2.emerge = "reload1";
    locations[n].reload.l2.autoreload = "0";
    ...
    ///////////////////////// офис плантатора /////////////////////////
    locations[n].id = "Bridgetown_Plantation_Sp2";
    locations[n].id.label = "TownhallRoom";
    ...
    //Reload map
    locations[n].reload.l1.name = "reload1";
    locations[n].reload.l1.go = "Bridgetown_Plantation_Sp1";
    locations[n].reload.l1.emerge = "reload2";
    locations[n].reload.l1.autoreload = "0";
    locations[n].reload.l1.label = "Townhall";
    n = n + 1;
    ...
    locations[n].reload.l1.name = "reload1";
    locations[n].reload.l1.go = "Bridgetown_Plantation";
    locations[n].reload.l1.emerge = "houseG6";
    locations[n].reload.l1.autoreload = "0";
    locations[n].reload.l1.label = "Plantation";
    n = n + 1;
	...
	locations[n].reload.l2.go = "Bridgetown_Plantation";
