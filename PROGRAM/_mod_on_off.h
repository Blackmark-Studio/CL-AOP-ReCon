...
#define VERSION_NUMBER1       " ver. 1.1.2 (11.06.2026)" // version build
...
// Killed body clear
#define MOD_DEAD_CLEAR           "Off" // Отключение удаления трупов. Konstrush
#define MOD_DEAD_CLEAR_TIME      2400 // in sec. Увеличение времени сохранения трупов.
