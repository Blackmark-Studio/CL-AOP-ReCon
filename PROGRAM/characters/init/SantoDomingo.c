...
int CreateSantoDomingoCharacters(int n)
{
	...
	ch.name		= FindPersonalName("SantoDomingo_Hostess_name");
	ch.lastname = "";
	ch.model	= "Maman_7";
	...
	ch.id		= "SantoDomingo_GlavSklad";
	ch.model	= "citiz_19";
	ch.sex = "man";
	ch.City = "SantoDomingo";
	ch.location	= "SantoDomingo_PackhouseOffice";
	ch.location.group = "sit";
	ch.location.locator = "sit1";
	...
	ch.id		= "SantoDomingo_bankvault";
	ch.model	= "citiz_11";
	ch.sex = "man";
	ch.City = "SantoDomingo";
	ch.location	= "SantoDomingo_bankvault";
	ch.location.group = "barmen";
	ch.location.locator = "stay";
	ch.Dialog.Filename = "House_dialog.c";
