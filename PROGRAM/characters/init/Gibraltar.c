...
int CreateGibraltarCharacters(int n)
{
	ref ch;
	...
	ch.id = "Gibraltar_Mayor";
	ch.model	= "huber_15";
	ch.sex = "man";
	ch.City = "Gibraltar";
	ch.location	= "Gibraltar_townhall";
	...
	ch.id = "Gibraltar_Priest";
	ch.model	= "priest_6";
	ch.model.animation = "man";
	ch.sex = "man";
	ch.City = "Gibraltar";
	ch.location	= "Gibraltar_church";
	...
	ch.id = "Gibraltar_waitress";
	ch.model	= "women_10";
	ch.sex = "woman";
	ch.City = "Gibraltar";
	ch.location	= "Gibraltar_tavern";
	...
	ch.id = "Gibraltar_trader";
	ch.model	= "trader_6";
	ch.greeting = "tra_common";
	ch.sex = "man";
	ch.City = "Gibraltar";
	ch.location	= "Gibraltar_Store";
	ch.location.group = "barmen";
	ch.location.locator = "stay";
	...
	ch.id = "Gibraltar_shipyarder";
	ch.model	= "shipowner_6";
	ch.greeting = "Gr_shipyarder";
	ch.sex = "man";
	ch.City = "Gibraltar";
	ch.location	= "Gibraltar_Shipyard";
	ch.location.group = "sit";
	ch.location.locator = "sit1";
	...
	ch.id		= "Gibraltar_usurer";
	ch.model	= "usurer_15";
	ch.sex = "man";
	ch.City = "Gibraltar";
	ch.location	= "Gibraltar_Bank";
	ch.location.group = "barmen";
	ch.location.locator = "stay";
	...
	ch.id		= "Gibraltar_PortMan";
	ch.model	= "portman_14";
	ch.sex = "man";
	ch.City = "Gibraltar";
	ch.location	= "Gibraltar_PortOffice";
	ch.location.group = "sit";
	ch.location.locator = "sit1";
	...
	ch.id		= "Gibraltar_GlavSklad";
	ch.model	= "citiz_17";
	ch.sex = "man";
	ch.City = "Gibraltar";
	ch.location	= "Gibraltar_PackhouseOffice";
	ch.location.group = "sit";
	ch.location.locator = "sit1";
	...
	ch.id		= "Gibraltar_bankvault";
	ch.model	= "citiz_19";
	ch.sex = "man";
	ch.City = "Gibraltar";
	ch.location	= "Gibraltar_bankvault";
	ch.location.group = "barmen";
	ch.location.locator = "stay";
	ch.Dialog.Filename = "House_dialog.c";
