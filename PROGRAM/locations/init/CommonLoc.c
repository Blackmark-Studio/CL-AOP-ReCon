int LocationInitCommonLoc(int n)
{
	...
	locations[n].models.always.window.tech = "LocationWindows";
	locations[n].models.always.window.level = 65539;
	locations[n].models.day.locators = "StoneHouse_locators"; // Смена локаторов перенесена в линейку Блада
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Doubleflour house and upstairs room ПКМ
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].models.always.TwoFloorHouse01 = "LH_Floor1";
	locations[n].models.always.TwoFloorHouse01.level = 65538;
	locations[n].models.day.locators = "LH_Floor1_locators";
	locations[n].models.night.locators = "LH_Floor1_locators";

	Locations[n].models.always.TwoFloorHouse01windows = "LH_Floor1_window";
	Locations[n].models.always.TwoFloorHouse01windows.tech = "LocationWindows";
	locations[n].models.always.TwoFloorHouse01windows.level = 65539;
	
	/*locations[n].models.always.Trapdoor = "trapdoor"; //люк в полу для квестов
	...
	locations[n].models.always.back.level = 65529;
	//Day
	//Locations[n].models.day.TwoFloorHouse01rand= "largehouse01_rand";
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "CommonTwoFloorRoom";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	n = n + 1;
	...
	//Always
	locations[n].filespath.models = "locations\inside\Doubleflour_house";
	locations[n].models.always.TwoFloorHouse02 = "LH_Floor2";
	locations[n].models.always.TwoFloorHouse02.level = 65538;
	locations[n].models.day.locators = "LH_Floor2_locators";
	locations[n].models.night.locators = "LH_Floor2_locators";

	Locations[n].models.always.TwoFloorHouse02windows = "LH_Floor2_window";
	Locations[n].models.always.TwoFloorHouse02windows.tech = "LocationWindows";
	locations[n].models.always.TwoFloorHouse02windows.level = 65539;

	locations[n].models.always.back = "..\inside_back";
	locations[n].models.always.back.level = 65529;
	//Day
	//Locations[n].models.day.TwoFloorHouse02rand= "largehouse02_rand";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Tripleflour house and upstairs and room ПКМ
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	locations[n].fastreload = "";
	//Models
	locations[n].filespath.models = "locations\Inside\Tripleflour_house";
	//Always
	locations[n].models.always.TripleFloorHouse01 = "LH_Floor1";
	locations[n].models.always.TripleFloorHouse01.level = 65538;
	locations[n].models.day.locators = "LH_Floor1_locators";
	locations[n].models.night.locators = "LH_Floor1_locators";
	
	Locations[n].models.always.TripleFloorHouse01windows = "LH_Floor1_window";
	Locations[n].models.always.TripleFloorHouse01windows.tech = "LocationWindows";
	locations[n].models.always.TripleFloorHouse01windows.level = 65539;
	...
	locations[n].models.always.back.level = 65529;
	//Day
	//Locations[n].models.day.TripleFloorHouse01rand= "largehouse01_rand";
	locations[n].models.day.charactersPatch = "LH_Floor1_patch";
	//Night
	locations[n].models.night.fonar = "LH_Floor1_fn";
	locations[n].models.night.charactersPatch = "LH_Floor1_patch";
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "CommonTripleFloorupstairs";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	n = n + 1;
	
	////////////////////////// 2 этаж с лестницей из ПКМ.
	locations[n].id = "CommonTripleFloorupstairs"; //с комнатой из таверны на втором этаже
	locations[n].id.label = "House";
	locations[n].image = "loading\inside\largehouse01.tga";
	locations[n].MustSetReloadBack = true;
	//Town sack
	...
	//Always
	locations[n].filespath.models = "locations\inside\largehouse01";
	locations[n].models.always.TripleFloorHouse02 = "largehouse01";
	locations[n].models.always.TripleFloorHouse02.level = 65538;
	locations[n].models.day.locators = "largehouse01_locators";
	locations[n].models.night.locators = "largehouse01_Nlocators";
	
	Locations[n].models.always.TripleFloorHouse02windows = "largehouse01_windows";
	Locations[n].models.always.TripleFloorHouse02windows.tech = "LocationWindows";
	locations[n].models.always.TripleFloorHouse02windows.level = 65539;
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "CommonTripleFloorHouse";
	locations[n].reload.l1.emerge = "none";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "";
	
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "CommonTripleFloorRoom";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	n = n + 1;
	...
	//Always
	locations[n].filespath.models = "locations\inside\Doubleflour_house";
	locations[n].models.always.TripleFloorHouse02 = "LH_Floor2";
	locations[n].models.always.TripleFloorHouse02.level = 65538;
	locations[n].models.day.locators = "LH_Floor2_locators";
	locations[n].models.night.locators = "LH_Floor2_locators";
	
	Locations[n].models.always.TripleFloorHouse02windows = "LH_Floor2_window";
	Locations[n].models.always.TripleFloorHouse02windows.tech = "LocationWindows";
	locations[n].models.always.TripleFloorHouse02windows.level = 65539;
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "CommonTripleFloorupstairs";
    ...
    locations[n].models.always.L4 = "jungle3_deadfall"; //деревья для тупиковых локаций Domovoy
