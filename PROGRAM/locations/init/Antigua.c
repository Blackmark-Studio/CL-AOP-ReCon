int LocationInitAntigua(int n)
{
    ...
    // --> Квестовые локации, четкая фиксация на 9 единиц, откр/закр только по квестам, обычно всегда открыты.
	...
	locations[n].reload.l11.questDisable = true;
	...
	locations[n].reload.l32.name = "boat";
	locations[n].reload.l32.go = "Antigua";
	locations[n].reload.l32.emerge = "reload_1";
	locations[n].reload.l32.autoreload = "0";
	locations[n].reload.l32.label = "Sea";
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "SentJons_Packhouse";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	// Пакгауз
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SentJons_Packhouse";
	...
	locations[n].reload.l1.go = "SentJons_Shipyard";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Shipyard";
	
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "SentJons_PackhouseOffice";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SentJons_PackhouseOffice";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "SentJons_Packhouse";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "SentJons_bankvault";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	LAi_LocationFightDisable(&locations[n], true);
	...
	// Хранилище (Банк)
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SentJons_bankvault";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "SentJons_bank";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	LAi_LocationFightDisable(&locations[n], true);
