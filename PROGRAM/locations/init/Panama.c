int LocationInitPanama(int n)
{
	...
	locations[n].reload.l2.go = "Panama_bankvault";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	// Хранилище (Банк)
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Panama_bankvault";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Panama_bank";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	LAi_LocationFightDisable(&locations[n], true);
	...
	locations[n].locators_radius.reload.reload2_back = 2.2;
	...
	locations[n].locators_radius.reload.reload1_back = 2.7;
...
/*	Locations[n].models.always.rays = "DungeonDuffer2_rays";
	...
	Locations[n].models.always.l2.level = 9;
	Locations[n].models.always.l2.tech = "DLightModel";
	Locations[n].models.always.l3 = "Jungle1_caveBlock";
	//Day
	...
	locations[n].locators_radius.reload.reload1_back = 2.4;
