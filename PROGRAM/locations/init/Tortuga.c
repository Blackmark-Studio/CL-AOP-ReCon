int LocationInitTortuga(int n)
{
	...
	// по французскому сюжету, дом подруги Фуше
	locations[n].reload.l17.name = "houseZ3";
	locations[n].reload.l17.go = "Tortuga_houseZ3";
	...
	locations[n].reload.l30.name = "boat";
	locations[n].reload.l30.go = "Tortuga";
	locations[n].reload.l30.emerge = "reload_1";
	locations[n].reload.l30.autoreload = "0";
	locations[n].reload.l30.label = "Sea";
	locations[n].locators_radius.reload.boat = 5.2;
	n = n + 1;
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Tortuga_bankvault";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	locations[n].reload.l2.label = "Room";
	LAi_LocationFightDisable(&locations[n], true);
	...
	// Хранилище (Банк)
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Tortuga_bankvault";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Tortuga_bank";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Street";
	LAi_LocationFightDisable(&locations[n], true);
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Tortuga_Packhouse";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	// Пакгауз
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Tortuga_Packhouse";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Tortuga_Shipyard";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Shipyard";
	
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Tortuga_PackhouseOffice";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Tortuga_PackhouseOffice";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Tortuga_Packhouse";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	...
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Tortuga_town";
	locations[n].reload.l1.emerge = "houseZ3";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "street";
	n = n + 1;
...
/*	Locations[n].models.always.rays = "DungeonVault1_rays";
	...
	locations[n].reload.l1.go = "Tortuga_Graveyard";
	locations[n].reload.l1.emerge = "reload2";
	...
	// городское кладбище
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Tortuga_Graveyard";
	...
	locations[n].reload.l3.name = "reload3";
	locations[n].reload.l3.go = "Tortuga_KeepersHouse";
	locations[n].reload.l3.emerge = "reload1";
	locations[n].reload.l3.autoreload = "0";
	locations[n].reload.l3.label = "House";
	
	locations[n].reload.l4.name = "reload4";
	locations[n].reload.l4.go = "Tortuga_CryptBig1";
	locations[n].reload.l4.emerge = "reload1";
	locations[n].reload.l4.autoreload = "0";
	locations[n].reload.l4.label = "CryptBig1";

	locations[n].reload.l5.name = "reload5";
	locations[n].reload.l5.go = "Tortuga_Crypt";
	locations[n].reload.l5.emerge = "reload1";
	locations[n].reload.l5.autoreload = "0";
	locations[n].reload.l5.label = "Crypt";

	locations[n].reload.l6.name = "reload6";
	locations[n].reload.l6.go = "Tortuga_Chapel";
	locations[n].reload.l6.emerge = "reload1";
	locations[n].reload.l6.autoreload = "0";
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// крипта большая - 1
	/////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Tortuga_CryptBig1";
	...
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Tortuga_CryptBig2";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// крипта большая - 2
	/////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Tortuga_CryptBig2";
	locations[n].id.label = "Crypt";
	locations[n].image = "loading\Crypt.tga";
	locations[n].MustSetReloadBack = true;
	//Town sack
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Tortuga_CryptBig1";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Crypt";
	
	locations[n].reload.l2.name = "reload2";
	locations[n].reload.l2.go = "Tortuga_CryptDungeon";
	locations[n].reload.l2.emerge = "reload1";
	locations[n].reload.l2.autoreload = "0";
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// логово Мерримана
	/////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Tortuga_CryptDungeon";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Tortuga_CryptBig2";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	locations[n].reload.l1.label = "Crypt";
	n = n + 1;
