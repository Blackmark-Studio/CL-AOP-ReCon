...
void CreateCharacters()
{
	...
	ch.name 	= FindPersonalName("Blaze_name");
	ch.lastname = FindPersonalName("Blaze_lastname");
	ch.id		= "Blaze";
	ch.nation	= ENGLAND;
	ch.model	= "devlin";
	ch.sex = "man";
    ...
    trace("Total NPC (static) = " + MAX_CHARACTERS);
	...
	NullCharacter.GenQuestFort.Providencia.how        = 3;
    NullCharacter.GenQuestFort.Providencia.howSolder  = 3;
